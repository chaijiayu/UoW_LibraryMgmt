...
<head>
    ...
    <title>Online Library Management System | Available Books</title>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * FROM booklist WHERE Status='Available'";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
											<a href="userborrowbook.php?bookid=<?php echo htmlentities($result->BookNo);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Borrow</button>
