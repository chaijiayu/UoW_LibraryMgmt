...
<head>
    ...
    <title>Online Library Management System | Books Records</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Books Records</h4>
    </div>
     <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ISBN</th>
                                            <th>Status</th>
											<th>Cost per day (for overdue borrowing)</th>
											<th>Borrow Date</th>
											<th>Return Date</th>
                                            <th>Action</th>
                                        </tr>
...
<?php
$sid=$_SESSION['userID'];
$sql = "SELECT * FROM booklist WHERE userID=:sid order by Userid desc";
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
											<a href="userreturnbook.php?bookid=<?php echo htmlentities($result->BookNo);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Return</button>
